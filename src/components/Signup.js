...
const Signup = () => {
  ...
  const handleButtonClick = (event) => {
    ...
    if (
      ...
      if (isEmailVisible) {
        ...
        // sliderRef.current.slickNext();
        document.getElementById("handleButton").innerText = t("Account Create");
      }
    } else {
  ...
  const handleEmail = () => {
    ...
    if (emailRegEx.test(email)) {
      ...
      setBtnSendEmailDisabled(false);
      document.getElementById("emailCheck").innerText = t(
        "Not in the format of the email."
      );
    }
  ...
  const confirm = () => {
    ...
    if (code === confirmCode) {
      ...
      document.getElementById("codeCheck").innerText = t(
        "It doesn't match. please verify again"
      );
    }
  };
  ...
  return (
    <Container component="main" maxWidth="xs" style={{ marginTop: "8%" }}>
      ...
      <form noValidate>
        ...
        {/*        {isEmailVisible ? (*/}
        {/*            <>*/}
        {/*            <SignupTextField value=t("email")/>*/}
        {/*            <Button >인증번호 발송</Button>*/}
        {/*            </>*/}
        {/*        ) : isPassVisible ? (*/}
        {/*            <SignupTextField value=t("password")/>*/}
        {/*        ) : isNicknameVisible ? (*/}
        {/*            <SignupTextField  value="nickname"/>*/}
        {/*        ) : isSubemailVisible ? (*/}
        {/*            <SignupTextField  value=t("subemail")/>*/}
        {/*        ) : isBirthdayVisible ? (*/}
            ...
            <Slider ref={sliderRef} {...settings} style={{ height: "10%" }}>
              <div>
                ...
                {loding ? (
                  ...
                  <div
                    style={{ width: 400, textAlign: "center", marginTop: 20 }}
                  >
                ...
                <div style={{ marginTop: "5%", outline: "none" }}>
                  <LocalizationProvider locale={ko} dateAdapter={AdapterDayjs}>
                    <DatePicker
                      ...
                      id={birthday}
                      disabled={btnDatePickerDisabled}
                      required
                    />
        ...
        <Grid item xs={12} style={{ marginTop: "5%" }}>
          {languageCode === "ko" && (
            <Link to="/PrivacyPolicyKo">{t("Privacy Policy")}</Link>
          )}
          {languageCode === "ja" && (
            <Link to="/PrivacyPolicyJa">{t("Privacy Policy")}</Link>
          )}
          {languageCode === "en" && (
            <Link to="/PrivacyPolicyEn">{t("Privacy Policy")}</Link>
          )}
        </Grid>
      </form>
    </Container>
